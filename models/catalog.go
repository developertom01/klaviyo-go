...
type (
	CatalogItemBulkCreateJobResource struct {
		Data CatalogItemBulkCreateJob `json:"data"`
	}

	CatalogItemBulkCreateJobCollectionResource struct {
		Data  []CatalogItemBulkCreateJob `json:"data"`
		Links Links                      `json:"links"`
	}

	CatalogItemBulkCreateJob struct {
		...
		Attributes    CatalogItemBulkCreateJobAttributes    `json:"attributes"`
		Links         DataLinks                             `json:"links"`
		Relationships CatalogItemBulkCreateJobRelationships `json:"relationships"`
	}

	CatalogItemBulkCreateJobAttributes struct {
		Status         CatalogItemBulkCreateJobStatus `json:"status"`          //Status of the asynchronous job.
	...
	CatalogItemBulkCreateJobRelationships struct {
		Items RelationshipDataCollection `json:"items"`
	}
)

type CatalogItemBulkCreateJobStatus string

const (
	CatalogItemBulkCreateJobStatusCancelled  CatalogItemBulkCreateJobStatus = "cancelled"
	CatalogItemBulkCreateJobStatusComplete   CatalogItemBulkCreateJobStatus = "complete"
	CatalogItemBulkCreateJobStatusProcessing CatalogItemBulkCreateJobStatus = "processing"
	CatalogItemBulkCreateJobStatusQueued     CatalogItemBulkCreateJobStatus = "queued"
)

type CatalogItemBulkCreateJobField string

const (
	CatalogItemBulkCreateJobFieldStatus         CatalogItemBulkCreateJobField = "status"
	CatalogItemBulkCreateJobFieldCreatedAt      CatalogItemBulkCreateJobField = "created_at"
	CatalogItemBulkCreateJobFieldTotalCount     CatalogItemBulkCreateJobField = "total_count"
	CatalogItemBulkCreateJobFieldCompletedCount CatalogItemBulkCreateJobField = "completed_count"
	CatalogItemBulkCreateJobFieldFailedCount    CatalogItemBulkCreateJobField = "failed_count"
	CatalogItemBulkCreateJobFieldCompletedAt    CatalogItemBulkCreateJobField = "completed_at"
	CatalogItemBulkCreateJobFieldErrors         CatalogItemBulkCreateJobField = "errors"
	CatalogItemBulkCreateJobFieldExpiredAt      CatalogItemBulkCreateJobField = "expired_at"
)

func BuildCatalogItemBulkCreateJobFieldParams(fields []CatalogItemBulkCreateJobField) string {
	if fields == nil {
		return ""
	}
